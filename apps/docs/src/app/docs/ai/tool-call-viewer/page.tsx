...
const BASIC_CODE = `import { ToolCallViewer } from "@animui/ui";
...
const STREAM_CODE = `import { ToolCallViewer } from "@animui/ui";
    ...
    <div className="space-y-10">
      ...
      <div className="rounded-xl bg-neutral-950 px-5 py-4">
        <code className="text-sm font-mono text-green-400">
          import {"{ ToolCallViewer }"} from <span className="text-blue-400">"@animui/ui"</span>
        </code>
      </div>
