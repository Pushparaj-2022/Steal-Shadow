...
const BASIC_CODE = `import { NumberFlow } from "@animui/ui";
import { useState } from "react";
...
export default function Example() {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <NumberFlow value={count} className="text-5xl font-semibold tabular-nums tracking-tight" />
  ...
  return (
    <div className="space-y-10">
      <div>
        ...
        <h1 className="text-4xl font-semibold tracking-tight text-neutral-900 tracking-tight mb-4">NumberFlow</h1>
      ...
      <div className="rounded-xl bg-neutral-950 px-5 py-4">
        <code className="text-sm font-mono text-green-400">
          import {"{ NumberFlow }"} from <span className="text-blue-400">"@animui/ui"</span>
        </code>
      </div>
      ...
      <section>
        ...
        <ComponentPreview code={BASIC_CODE}>
          <div className="flex flex-col items-center gap-6 py-6 w-full bg-neutral-50 rounded-xl">
            <NumberFlow value={count} className="text-5xl font-semibold tabular-nums tracking-tight text-neutral-900" />
            <div className="flex gap-2">
              <button
      ...
      <section>
        ...
        <ComponentPreview code={PRICE_CODE}>
          <div className="flex items-center justify-center gap-6 p-6 w-full bg-neutral-50 rounded-xl flex-wrap">
            {[9, 29, 99].map(price => (
              <div key={price} className="text-center">
                <NumberFlow value={price} prefix="$" decimals={2} className="text-4xl font-semibold tracking-tight text-neutral-900" />
