...
const BASIC_CODE = `import { CommandPalette, useCommandPalette } from "@stealshadow/ui";
    ...
    <div className="space-y-10">
      ...
      <div className="rounded-xl bg-neutral-950 px-5 py-4">
        <code className="text-sm font-mono text-green-400">
          import {"{ CommandPalette, useCommandPalette }"} from <span className="text-blue-400">"@stealshadow/ui"</span>
        </code>
      </div>
